...
public static class DiscoveryHubCatalog
{
    ...
    [
        ...
        new("Farmacias y salud", "farmacias", "svc-farmacias", "farmacia", "health-personal-care",
            "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=800&q=75"),
        new("Agronegocios y campo", "agronegocios", "svc-agronegocios", "agricultura agronegocio", "food-beverages",
            "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=75"),
        new("Automotriz y mecánica", "automotriz", "svc-automotriz", "taller mecánica automotriz", "tech-accessories",
            "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=75"),
        new("Clínicas y salud", "clinicas-salud", "svc-clinicas-salud", "clínica salud", "health-care",
            "https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=800&q=75"),
        new("Construcción y obras", "construccion-empresas", "svc-construccion", "construcción", "home-cleaning",
            "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=800&q=75"),
        new("Peluquerías y estética", "peluquerias", "svc-peluquerias", "peluquería belleza", "fashion-accessories",
            "https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=800&q=75"),
        new("Alimentos y bar", "alimentos-bar", "svc-alimentos-bar", "alimentos restaurant", "food-beverages",
            "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=75"),
        new("Educación y cursos", "educacion", "svc-educacion", "educación curso", "stationery-office",
            "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=800&q=75"),
        new("Tecnología y computación", "tecnologia", "svc-tecnologia", "tecnología reparación", "tech-accessories",
            "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=800&q=75"),
        new("Hogar y reparación", "hogar-reparacion", "svc-hogar-reparacion", "hogar mantención", "home-cleaning",
            "https://images.unsplash.com/photo-1621905251918-48416bd8575a?auto=format&fit=crop&w=800&q=75"),
        new("Limpieza y mantención", "limpieza", "svc-limpieza", "limpieza mantención", "home-cleaning",
            "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=800&q=75"),
        new("Inmobiliaria e inmuebles", "inmobiliaria", "svc-inmobiliaria", "inmobiliaria", "inmuebles",
